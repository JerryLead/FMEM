...
public class SplitMapperCompJvmCost {
	...
	public SplitMapperCompJvmCost(SplitMapperRealJvmCost rJvmCost, SplitMapperPredictedJvmCost eJvmCost) {
	...
	public String toString() {
		...
		return split + "\t" + xmx + "\t" + xms + "\t" + ismb + "\t" + RN + "\t" + Bytes + "\t" 
